...
public class Suppliesv2 {
    public static void main(String[] args) {
        ...
        suppliesv2.populateStack4();
        suppliesv2.populateStack5();
        suppliesv2.populateStack6();
        suppliesv2.populateStack7();
        suppliesv2.populateStack8();
        suppliesv2.populateStack9();
        ...
        for(int x=0; x<newStack.length; x++){

        System.out.print(newStack[x].peek());}
